...
- **Tone**: Pick an extreme: brutally minimal, luxury/refined, editorial/magazine, industrial/utilitarian, etc. Use these for inspiration but design one that is true to the aesthetic direction.
